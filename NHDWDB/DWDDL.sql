...
--	DWDIM_SOURCEID  NVARCHAR(50) NOT NULL, -- THE HOSPITAL STAFF UNIQUE ID 
...
--	DW_SOURCEID -- concat vaue of the row 
...
--added an alternate source id column to cope with compsite key
