...
-------------------- QUERIES FOR THE CONCAT AND GETTING TH EMEASUREMNT IDS -FROM INSIDE TIMS DB-----------

--SELECT P.URNUMBER, DP.MEASUREMENTID, DP.DATAPOINTNUMBER, CONVERT(CHAR(8), PM.FREQUENCYSETDATE, 112) as freqencysetdate, 
...
--					   --WHERE CONCAT(P.URNumber, '-' , CONVERT(CHAR(8), MR.DATETIMERECORDED, 112), '-', DP.MEASUREMENTID, '-' ,DP.DATAPOINTNUMBER) 
					   

--select CONCAT(P.URNumber, '-' , CONVERT(CHAR(8), MR.DATETIMERECORDED, 112), '-', DP.MEASUREMENTID, '-' ,DP.DATAPOINTNUMBER)
-- FROM DDDM_TPS_1.DBO.PATIENT P  
--                       INNER JOIN DDDM_TPS_1.DBO.PATIENTCATEGORY PC  
--                       ON P.URNUMBER = PC.URNUMBER  
--					   INNER JOIN DDDM_TPS_1.DBO.PATIENTMEASUREMENT PM  
