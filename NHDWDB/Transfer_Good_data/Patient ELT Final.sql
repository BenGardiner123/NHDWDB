use NHDW
IF OBJECT_ID('ETL_NHRM_PATIENT_FILTER') IS NOT NULL
DROP PROCEDURE ETL_NHRM_PATIENT_FILTER;
GO
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE ETL_NHRM_PATIENT_FILTER 
as
begin
	...
	------------------------need to add all the correct values below------------------------
